                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="alert alert-warning">
                            ...
                            <h4>上传&nbsp;<strong style="color:blue">&lt;&lt;JAVA EE&gt;&gt;&nbsp;&nbsp;${experName}&nbsp;</strong>报告</h4>
                            <h5><strong>(报告大小限制1M以内，可以压缩并将压缩后的文件上传)</strong></h5>
                        </div>
                    </div>
                    <div class="panel-body">
                        <Form action="../UploadServlet?opptype=assignment" method="post" ENCTYPE="multipart/form-data">
                            <div class="form-group">
                                <input class="form-control" type="file" name="file1" />
                                <br />
                                <input class="btn btn-primary" type="submit" value="上&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;传" />
                                &nbsp;&nbsp;&nbsp;<a class="btn btn-primary"  href="myExperiment.jsp" >返&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;回</a>
                            </div>
                        </Form>
                    </div>
                </div>
